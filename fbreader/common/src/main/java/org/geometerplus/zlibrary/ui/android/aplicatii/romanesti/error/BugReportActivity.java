...
package org.geometerplus.zlibrary.ui.android.aplicatii.romanesti.error;
	...
	public void onCreate(Bundle icicle) {
		...
		findViewById(R.id.send_report).setOnClickListener(new View.OnClickListener() {
			public void onClick(View view) {
				...
				sendIntent.putExtra(Intent.EXTRA_EMAIL, new String[] { "aplicatii.romanesti@gmail.com" });//exception@fbreader.org
